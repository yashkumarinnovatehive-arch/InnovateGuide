          ...
          {showSearch && (
            <div className="relative hidden sm:flex items-center">
              ...
              <input
                ...
                placeholder="Search..."
                className="
                  pl-9 pr-4 py-2 w-56 text-sm font-inter
          ...
          <div className="flex items-center gap-3 pl-4 border-l border-border">
            ...
            <div
              className="
                ...
                bg-accent-gradient text-white font-sora font-bold text-sm
                shadow-card ring-2 ring-accent/20 select-none
              "
            >
              A
            </div>
            ...
            <div className="flex flex-col leading-tight">
              ...
              <span
                className="
                  inline-flex items-center self-start px-1.5 py-0.5 rounded
                  bg-accent/10 text-accent text-[10px] font-inter font-semibold
                  uppercase tracking-wider leading-none mt-0.5
                "
              >
                Administrator
              </span>
