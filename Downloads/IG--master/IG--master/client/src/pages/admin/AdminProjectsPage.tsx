...
const AdminProjectsPage: React.FC = () => {
  ...
  return (
    <div className="flex flex-col gap-6">
      <AdminHeader title="Admin Projects Management" />
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3 flex-wrap">
          ...
          <Link to="/admin/admin-projects/new">
      ...
      <div className="relative w-full sm:max-w-sm">
        ...
        <input
          ...
          className="
            w-full pl-9 pr-4 py-2 text-sm font-inter
                      ...
                      <div className="flex items-center justify-center gap-2">
                        ...
                        <Link to={`/projects/${project.id}`}>
                          <button
                            title="View project"
                            className="
                              p-1.5 rounded-lg text-teal-600 bg-teal-50
                        ...
                        {/* Edit */}
                        <Link to={`/admin/admin-projects/${project.id}/edit`}>
                          <button
                            title="Edit project"
                            className="
                              p-1.5 rounded-lg text-blue-600 bg-blue-50
          ...
          <div className="flex items-center justify-between border-t border-border px-5 py-3 bg-white">
            ...
            <div className="flex items-center gap-1">
              <button
                ...
                className="
                  p-1.5 rounded-lg text-primary-600
              ...
              {Array.from({ length: totalPages }, (_, i) => i + 1).map((page) => (
                <button
                  ...
                  className={`
                    h-7 w-7 rounded-lg text-xs font-inter font-medium
                    transition-colors duration-150
                    ${
                      page === currentPage
