...
import type { DifficultyLevel, ProjectType, ProjectStatus } from '@ig-types/index'
...
const EditProjectPage: React.FC = () => {
  ...
  return (
    <div className="flex flex-col gap-6">
      <AdminHeader title="Edit Project" subtitle={`Editing: ${project.title} — ID: ${id}`} />

      <div className="flex items-center gap-3">
        <Button variant="outline" size="sm" onClick={() => navigate('/admin/admin-projects')} className="gap-1.5">
          <ArrowLeft size={15} />
          Back
        </Button>
      </div>
